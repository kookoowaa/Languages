...
Public Function GetLocalWorkbookName(Optional ByVal PathOnly As Boolean = False) As String
    ...
    isOneDrivePath = InStr(1, ThisWorkbook.fullName, "https://", vbTextCompare) > 0
    
    If isOneDrivePath = False Then
        result = ThisWorkbook.fullName
    Else
        Set localFolders = GetLocalFolders
        
        evalPath = RemoveTopFoldersByQty(ThisWorkbook.fullName, ONEDRIVE_PATH_SLASHES)
